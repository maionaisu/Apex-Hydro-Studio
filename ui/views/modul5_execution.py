...
class Modul5Execution(QWidget):
    ...
    def setup_ui(self) -> None:
        ...
        # Proporsi: Terminal mengambil 60% tinggi layar saat dibuka
    ...
    def start_engine(self) -> None:
        ...
        self.terminal.clear()
        self.terminal.append(f"<span style='color:#595FF7; font-weight:bold;'>▶ [HPC ORCHESTRATOR] Memulai mesin komputasi C++...</span>")
        ...
        self.terminal.append(f"<span style='color:#8FC9DC;'>  ├ Target File: {target_file}</span><br><br>")
        
        # Meneruskan Target Config ke DIMR Manager (Tidak lagi ter-hardcode ke dimr_config.xml)
    ...
    def log_stderr(self, text: str) -> None:
        self.terminal.append(f"<span style='color: #F7C159;'>[DIMR WARN] {text}</span>")
