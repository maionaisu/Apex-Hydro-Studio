...
class FormRow(QWidget):
    ...
    def __init__(self, label_text: str, input_widget: QWidget, parent=None):
        ...
        # [ACCESSIBILITY FIX]: Tautkan QLabel dengan widget input agar screen reader dapat mengidentifikasi konteks form
...
class ModernButton(QPushButton):
    ...
    def __init__(self, text: str, btn_type: str = "primary", parent=None):
        ...
        # [ACCESSIBILITY FIX]: Bersihkan emoji dari label karena Screen Reader akan tergagap jika membacanya
