...
class ModernButton(QPushButton):
    ...
    def __init__(self, text: str, btn_type: str = "primary", parent=None):
        ...
        # [ACCESSIBILITY] Strip emojis for screen reader name
    ...
    def set_loading(self, is_loading: bool, loading_text: str = "⏳ Memproses...") -> None:
        ...
        if is_loading:
            ...
            clean_loading_name = re.sub(r'[\U0001F300-\U0001FAFF\u25A0-\u25FF\u2700-\u27BF\u2600-\u26FF\u2B00-\u2BFF\u2300-\u23FF\uFE0F]', '', loading_text).strip()
            if clean_loading_name:
                self.setAccessibleName(clean_loading_name)
        else:
            self.setText(self._original_text)
            clean_orig_name = re.sub(r'[\U0001F300-\U0001FAFF\u25A0-\u25FF\u2700-\u27BF\u2600-\u26FF\u2B00-\u2BFF\u2300-\u23FF\uFE0F]', '', self._original_text).strip()
            if clean_orig_name:
                self.setAccessibleName(clean_orig_name)
