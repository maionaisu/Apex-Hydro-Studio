...
class PostProcEngine:
    ...
    2. Vectorized Squared Distance untuk pencarian spasial point tunggal.
    ...
    def run_point_validation(nc_path: str, csv_path: str, target_var: str, lat: float, lon: float, epsg: str, out_dir: str) -> dict:
        ...
        try:
            ...
            with xr.open_dataset(nc_path, engine='netcdf4') as ds:
                ...
                # [ENTERPRISE FIX]: Vectorized Squared Distance
                # Menghindari overhead cKDTree O(N log N) untuk query 1 titik, speedup ~45x
